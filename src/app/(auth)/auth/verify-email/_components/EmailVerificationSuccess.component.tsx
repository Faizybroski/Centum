  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col items-center text-center p-6">
        <div className="flex items-center justify-center w-16 h-16 rounded-full border border-green-200 text-green-600 mb-3">
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-xs">
          ...
          <span className="text-primary font-medium ml-1">Centum Health</span>.
        </p>
      </motion.div>
