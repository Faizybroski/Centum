...
export default function CustomerHeader({ children }: { children: React.ReactNode }) {
    ...
    <SidebarProvider>
          <div className="min-h-screen flex w-full bg-gradient-to-br from-background via-background/95 to-muted/20 ">
            ...
            <div className="flex-1 flex flex-col">
              {/* Header */}
              <header className="bg-card/80 backdrop-blur-sm px-3 flex items-center justify-between shadow-sm sticky top-0 z-50 bg-white border-b border-border">
                    ...
                    <SheetContent side="right" className="w-[300px] sm:w-[350px]">
                      <SheetHeader>
                        <SheetTitle className="flex items-center justify-center">
                          ...
                          <Image src="/assets/icons/centum_health-logo.svg" alt="Centum Health" className="h-15 object-contain" height={750} width={750} priority />
                        </SheetTitle>
                      </SheetHeader>
    
                      <div className="mt-1 flex flex-col space-y-4 px-4">
                        {/* User Info */}
